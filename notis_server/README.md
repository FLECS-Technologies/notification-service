# Rust API for notis_server

Notis API Specification
...
- API version: 1.0.0
- Build date: 2025-06-25T08:58:15.838646947Z[Etc/UTC]
- Generator version: 7.11.0



This autogenerated project defines an API crate `notis_server` which contains:
...
#[async_trait]
impl notis_server::Api for ServerImpl {
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = notis_server::server::new(Arc::new(ServerImpl));
